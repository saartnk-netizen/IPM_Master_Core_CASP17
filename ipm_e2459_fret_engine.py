...
# ============================================================================
# ARCHITECTURAL WORKSPACE (V8.11 ENSEMBLE ENGINE - FRET CONFORMATIONAL PROTOCOL)
# ============================================================================
...
class IPMAlphaFoldOracle:
    def execute_af2(self, target_id, input_a3m, output_dir, total_models, num_recycles, sequence=""):
        ...
        print(f"  -> [PHASE 3] ENGAGING ALGORITHMIC MESH DECIMATION (FRET Conformational Extraction)")
...
def main():
    print("\n=======================================================")
    print("    IPM ENSEMBLE ENGINE (V8.11 - FRET CONFORMATIONAL PROTOCOL)   ")
    print("=======================================================\n")
    
    try:
        models_input = input("Enter total number of ensemble models to generate (1-400) [Default: 100]: ").strip()
        total_models = int(models_input) if models_input.isdigit() and 1 <= int(models_input) <= 400 else 100
    except ValueError:
        total_models = 100
